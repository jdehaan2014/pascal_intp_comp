...
uses
  ...
  uEOFToken, uPredefined, uGenericInterfaces, uObjectUtils;
...
initialization
  TPascalParserTD.ErrorHandler := TPascalErrorHandler.Create;

finalization
  if Assigned(TPascalParserTD.ErrorHandler) then
    TPascalParserTD.ErrorHandler.Free;
