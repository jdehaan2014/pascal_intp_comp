...
uses
  Classes, SysUtils, usource, ubaseparser, ubackend, uBackendFactory, usymtab,
  ucode, uCrossRef, umessages, uFrontendFactory,
  ...
  try
    ...
    if Parser.getErrorCount = 0 then begin
      ...
      if Intermediate then begin
        ...
        treePrinter.Print(ICode, OutPutList);
        OutPutList.SaveToFile('TreeOutput.txt');
        OutPutList.Destroy;
      end;
