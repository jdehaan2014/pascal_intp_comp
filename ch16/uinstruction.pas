...
type
  ...
  TInstructionSet = set of TInstruction.Values;

  { TInstructionSetHelper }

  TInstructionSetHelper = type helper for TInstructionSet
    function Contains(Instruction: TInstruction.Values): boolean;
  end;
...
function TInstructionSetHelper.Contains(Instruction: TInstruction.Values): boolean;
begin
  Result := Instruction in Self;
end;
