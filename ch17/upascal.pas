...
begin
  try
    try
      ...
      Lines := Pos('l', Flags) > 0;         //,, to print source line tracing
      Assign := Pos('a', Flags) > 0;         //,, to print value assignment tracing
      Fetch := Pos('f', Flags) > 0;         //,, to print value fetch tracing
      Call := Pos('c', Flags) > 0;         //,, to print routine call tracing
      Return := Pos('r', Flags) > 0;         //,, to print routine return tracing
