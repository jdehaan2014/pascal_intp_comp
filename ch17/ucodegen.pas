...
implementation
uses uObjectUtils, uSymtabImpl, uGenerators;
...
var
  ...
  ProgramGenerator: TProgramGenerator;
  OutPutDir: string;
begin
  ...
  OutPutDir :=
    '/Users/Jeroen/Documents/Programming/Pojects/WritingCompAndInterp/Output/';
  AssemblyFileName := OutPutDir + ProgName + '.j';
  //Open a new assembly file for writing
  AssemblyFile := TStringList.Create;
  try
    //Generate code for the main program.
    ProgramGenerator := TProgramGenerator.Create(Self);
