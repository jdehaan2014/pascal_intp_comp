...
type
  ...
  TSymTabImpl = class(TSymTabEntryMap, ISymtab)
    private
      ...
      FSlotNumber: integer;     //local variables array slot number
      FMaxSlotNumber: integer;  //max slot number value
    public
      function toString: string; override;
      function getObject: TObject;
      ...
      function nextSlotNumber: Integer;
      function maxSlotNumber: Integer;
  end;
...
//return the next local variables array slot no
function TSymTabImpl.nextSlotNumber: Integer;
begin
  Inc(FSlotNumber);
  FMaxSlotNumber := FSlotNumber;
  Result := FSlotNumber;
end;

//return max local variables array slot number
function TSymTabImpl.maxSlotNumber: Integer;
begin
  Result := FMaxSlotNumber;
end;
