...
type
  ...
  { THashFunction used for GHashSet (fcl-stl) }
  THashFunction = class
    public
      class function Hash(a: longint; n: longint): longint ;
  end;
  ...
  TString = class
    ...
    public
      ...
      function Append(const c: char): TString;
      function Append(const tc: TChar): TString;
      function Append(const SubString: String): TString;
      function Append(const SubTString: TString): TString;
...
class function THashFunction.Hash(a: longint; n: longint): longint;
begin
  Result := (a xor (a shr 5) xor (a shl 7)) and (n-1);
end;
...
function TString.Append(const c: char): TString;
begin
  FValue := FValue + c;
  Result := Self;
end;

function TString.Append(const tc: TChar): TString;
begin
  FValue := FValue + tc.Value;
  Result := Self;
end;

function TString.Append(const SubString: String): TString;
begin
  FValue := FValue + SubString;
  Result := Self;
end;

function TString.Append(const SubTString: TString): TString;
begin
  FValue := FValue + SubTString.Value;
  Result := Self;
end;
